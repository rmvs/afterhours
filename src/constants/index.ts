...
export const FAQTexts = [
    ...
    },
    {
        ...
        children: `Yes, our sleep mask is designed to be one-size-fits-all with its conforming shape and strap-free design allowing it to comfortably fit most faces. Our mask is crafted as 2 separate sleep mask patches which confirm around the eyes to block out light.`
    },
    {
        key: 7,
